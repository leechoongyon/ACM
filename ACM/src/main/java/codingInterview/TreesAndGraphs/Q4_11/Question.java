...
public class Question
{
	public static void main(String [] args)
	{
		...
		Node n1 = bt.makeBT(5, null, null);
		Node n2 = bt.makeBT(7, null, null);
		Node n3 = bt.makeBT(3, null, null);
		Node n4 = bt.makeBT(1, null, null);
		Node n5 = bt.makeBT(6, n1, n2);
	 ...
	 */
	public static int countTargetSumRoute(Node<Integer> node, int targetSum)
	{
		/** 초기 사례 */
	...
	public static int countTargetSumRouteFromRoot(Node<Integer> node, int runningSum, int targetSum)
	{
		int targetSumRouteCount = 0;
		/** 초기 사례 */
		if (node == null)
